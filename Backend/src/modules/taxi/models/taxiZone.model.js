...
taxiZoneSchema.index({ status: 1, country: 1 });
taxiZoneSchema.index({ status: 1, displayOrder: 1 });
taxiZoneSchema.index({ isDeleted: 1, status: 1, createdAt: -1 });

export const TaxiZone = mongoose.models.TaxiZone
    || mongoose.model('TaxiZone', taxiZoneSchema, 'taxi_zones');
