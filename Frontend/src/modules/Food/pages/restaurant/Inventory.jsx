        ...
        <div ref={tabBarRef} className="grid grid-cols-2 gap-3">
          <motion.button
            ...
            className={`relative overflow-hidden rounded-[24px] border px-4 py-3 text-sm font-semibold whitespace-nowrap ${activeTab === "all-items"
              ? "border-[#FF6A00] text-white shadow-[0_18px_32px_-24px_rgba(73,171,20,0.8)]"
          ...
          >
            {activeTab === "all-items" && (
              <motion.div
                ...
                className="absolute inset-0 rounded-[24px] bg-[#FF6A00] -z-10"
                initial={false}
                transition={{
                  type: "spring",
                  stiffness: 500,
            ...
            <span className="relative z-10 flex items-center justify-center gap-2">
              <span>All items</span>
              <span className={`rounded-full px-2 py-0.5 text-xs font-semibold ${activeTab === "all-items" ? "bg-white text-[#FF6A00]" : "bg-slate-100 text-slate-600"
                }`}>
                {totalItems}
              </span>
            </span>
                ...
                return (
                  <button
                    ...
                    className={`shrink-0 rounded-full border px-3 py-1.5 text-xs font-semibold transition-colors ${isActive
                      ? "border-[#FF6A00] bg-[#FF6A00] text-white shadow-[0_14px_28px_-24px_rgba(255, 106, 0,0.5)]"
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <button
                        ...
                        className="px-4 py-2 bg-[#FF6A00] text-white rounded-md text-sm font-medium hover:bg-[#E64D02] disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                      >
      ...
      <div className="fixed right-4 bottom-24 z-30 flex flex-col items-end gap-2">
        {activeTab === "add-ons" ? (
          <motion.button
            ...
            className="rounded-full bg-[#FF6A00] px-5 py-3 text-sm font-semibold text-white shadow-[0_22px_40px_-24px_rgba(73,171,20,0.6)]"
          >
            + Add add-on
          </motion.button>
        ) : (
