      ...
      <div className="w-full lg:w-1/2 h-full flex flex-col">
        ...
        <div className="relative flex items-center justify-center px-6 sm:px-10 lg:px-16 pt-6 pb-4">
          ...
          >
            {logoUrl ? (
              ...
              <div className="h-11 w-11 rounded-xl bg-[#FF6A00] flex items-center justify-center text-white shadow-lg overflow-hidden shrink-0">
                <UtensilsCrossed className="h-6 w-6" />
              </div>
            )}
            <div className="flex flex-col items-start">
              <span className="text-2xl font-bold tracking-wide text-[#FF6A00]">
                {companyName}
              </span>
        ...
        >
          ...
          >
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className={`h-11 pl-9 border-gray-300 rounded-md shadow-sm focus-visible:ring-[#FF6A00] focus-visible:ring-2 transition-colors placeholder:text-gray-400 ${errors.name ? "border-red-500" : ""}`}
                  required
                />
              </div>
              {errors.name && (
                ...
                <div className="flex-1 min-w-0">
                  <div className="relative">
                    ...
                    <Input
                      ...
                      onChange={handleChange}
                      className={`h-11 pl-9 border-gray-300 rounded-md shadow-sm focus-visible:ring-[#FF6A00] focus-visible:ring-2 transition-colors placeholder:text-gray-400 ${errors.phone ? "border-red-500" : ""}`}
                      required
                    />
                  </div>
                </div>
            ...
            <Button
              type="submit"
              className="mt-2 h-11 w-full bg-[#FF6A00] hover:bg-[#FF6A00]/90 text-white text-base font-semibold rounded-md shadow-md transition-colors"
              disabled={isLoading}
            >
              {isLoading ? (
                <>
          ...
          <div className="mt-8 w-full max-w-lg rounded-lg border border-red-100 bg-red-50 px-4 py-3 text-xs sm:text-sm text-gray-800 flex items-start gap-3">
            <div className="mt-0.5 text-[#FF6A00]">
