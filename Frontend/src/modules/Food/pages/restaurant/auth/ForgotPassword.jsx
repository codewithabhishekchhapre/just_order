    ...
    <div className="h-screen w-full flex bg-white overflow-hidden">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative">
        ...
        <div className="absolute inset-0 flex items-center text-white pointer-events-none">
          <div className="bg-[#FF6A00]/80 rounded-r-full py-10 xl:py-20 pl-10 xl:pl-14 pr-10 xl:pr-20 max-w-[70%] shadow-xl backdrop-blur-[1px]">
          ...
          <CardContent className="space-y-6">
            ...
            {step === 1 && (
              <form onSubmit={handleEmailSubmit} className="space-y-5">
                ...
                <Button
                  type="submit"
                  className="h-11 w-full bg-[#FF6A00] hover:bg-[#FF6A00]/90 text-white"
                  disabled={isLoading}
                >
              ...
              <form onSubmit={handleOtpSubmit} className="space-y-5">
                  ...
                  <div className="flex justify-center gap-2">
                    {otp.map((digit, index) => (
                      <Input
                        ...
                        className="h-14 w-14 text-center text-2xl font-semibold border-2 focus-visible:ring-2 focus-visible:ring-[#FF6A00]"
                        disabled={isLoading}
                      />
                    ))}
                  </div>
                ...
                <div className="flex items-center justify-between text-sm">
                  <button
                    type="button"
                    onClick={() => setStep(1)}
                    className="flex items-center gap-2 text-[#FF6A00] hover:text-[#FF6A00]/80 transition-colors"
                    disabled={isLoading}
                  >
                  ...
                  <button
                    ...
                    className="text-[#FF6A00] hover:underline font-medium disabled:text-gray-400 disabled:no-underline"
                  >
            ...
            <div className="pt-4 border-t">
              <button
                ...
                className="flex items-center gap-2 text-sm text-[#FF6A00] hover:text-[#FF6A00]/80 transition-colors"
              >
                <ArrowLeft className="h-4 w-4" />
                Back to login
              </button>
