            ...
            <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-3xl p-6 text-white shadow-xl relative overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-2 mb-4">
                  <span className="bg-[#FF6A00] text-[10px] font-bold px-2 py-0.5 rounded-full uppercase tracking-widest">Active Plan</span>
                </div>
            ...
            sortedPlans.map((plan) => {
              ...
              return (
                <motion.div 
                  key={plan._id} 
                  whileHover={{ y: -5 }}
                  className={`bg-white rounded-3xl p-6 border-2 transition-all shadow-sm flex flex-col ${isCurrentPlan ? 'border-[#FF6A00]' : 'border-slate-100'}`}
                >
                    ...
                    <div className="bg-slate-50 border border-slate-200 rounded-3xl p-5 relative overflow-hidden group/info">
                      <div className="flex items-start gap-3 relative z-10">
                        <div className="w-8 h-8 rounded-xl bg-white border border-slate-200 flex items-center justify-center shrink-0 shadow-sm">
                          <Info className="w-4 h-4 text-slate-400 group-hover/info:text-[#FF6A00] transition-colors" />
                        </div>
                        <div>
                          <div className="flex items-center gap-2 mb-1">
                            <p className="font-bold text-slate-900 text-sm">Auto Activated</p>
                            <span className="bg-[#FF6A00]/10 text-[#FF6A00] text-[8px] font-black px-1.5 py-0.5 rounded-md uppercase tracking-wider">Smart Flow</span>
                          </div>
                      ...
                      <div className="absolute top-0 right-0 p-3 opacity-[0.03] group-hover/info:opacity-[0.07] transition-opacity">
                        <Zap className="w-16 h-16 text-[#FF6A00]" />
                      </div>
                    </div>
                  ) : (
                    <Button 
                      ...
                      className={`w-full h-12 rounded-2xl font-bold text-sm tracking-wide transition-all ${(isCurrentPlan || isLocked) ? 'bg-slate-100 text-slate-400' : 'bg-[#FF6A00] hover:bg-[#E64D02] text-white shadow-lg shadow-[#FF6A00]/20'}`}
                    >
                      {purchasing === plan._id ? (
