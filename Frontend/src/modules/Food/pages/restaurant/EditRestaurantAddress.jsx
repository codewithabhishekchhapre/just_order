        ...
        <div className="absolute bottom-0 left-0 right-0 bg-white rounded-t-3xl z-20 px-4 pt-6 shadow-[0_-4px_20px_rgba(0,0,0,0.1)]">
          ...
          <div className="pb-4">
            <button
              ...
              className={`w-full bg-[#FF6A00] hover:bg-[#e05e00] text-white font-semibold py-4 text-base rounded-xl flex items-center justify-center gap-2 transition-colors ${loading || saving ? "opacity-70 cursor-not-allowed" : ""}`}
            >
              {(loading || saving) ? (
                <>
