  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#0a0a0a]">
      ...
      <div className="bg-white dark:bg-[#111] border-b border-gray-100 dark:border-gray-800 px-4 py-4 sticky top-0 z-50">
        <h1 className="text-base font-bold text-gray-900 dark:text-white">Account</h1>
        <p className="text-xs text-gray-400 dark:text-gray-500 mt-0.5">Profile, compliance & referrals</p>
      </div>
