      ...
      <Modal
        ...
        footer={
          <Button
            ...
            className="w-full h-14 bg-[#FF6A00] hover:bg-[#e05e00] text-white rounded-2xl font-black text-lg shadow-xl disabled:opacity-50"
        ...
        <div className="mb-6">
          ...
          <div className="relative">
            ...
            <Input
              ...
              className="pl-8 h-14 text-xl font-black border-2 border-gray-100 dark:border-gray-700 focus:border-[#FF6A00] rounded-2xl"
        ...
        <div className="grid grid-cols-3 gap-2">
          {quickAmounts.map(amt => (
            <button
              ...
              className="py-3 rounded-xl text-sm font-bold border-2 border-gray-100 dark:border-gray-700 text-gray-700 dark:text-gray-300 hover:border-[#FF6A00] hover:text-[#FF6A00] transition-all"
            >
              ₹{amt}
            </button>
          ))}
