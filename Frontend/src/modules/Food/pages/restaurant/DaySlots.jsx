    ...
    >
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        {dayData.slots.length < 3 && (
          <button
            onClick={addSlot}
            className="w-full text-[#FF6A00] hover:text-[#e05e00] text-sm font-medium py-3 transition-colors"
          >
            + Add time slot
          </button>
        )}
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-3">
            <Checkbox
              ...
              className="w-5 h-5 border-2 border-gray-300 rounded data-[state=checked]:bg-[#FF6A00] data-[state=checked]:border-[#FF6A00]"
            />
            <label
              htmlFor="copy-to-all"
          ...
          <Button
            onClick={handleSave}
            className="w-full bg-[#FF6A00] hover:bg-[#e05e00] text-white font-semibold py-3 rounded-xl"
          >
            Save
          </Button>
        </div>
