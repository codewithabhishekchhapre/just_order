      ...
      <div className="bg-white dark:bg-[#111] border-b border-gray-100 dark:border-gray-800 px-4 py-4 sticky top-0 z-50">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            <p className="text-xs text-gray-400 dark:text-gray-500">Order history for</p>
        ...
        <div className="flex items-center gap-2">
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 bg-white dark:bg-[#111] border border-gray-200 dark:border-gray-700 rounded-xl text-sm text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:border-[#FF6A00] focus:ring-1 focus:ring-[#FF6A00]/30"
            />
          </div>
          <button
          ...
          >
            ...
            {hasActiveFilters() && (
              <span className="absolute -top-1 -right-1 w-4 h-4 bg-[#FF6A00] rounded-full text-white text-[10px] flex items-center justify-center font-bold">
      ...
      {hasActiveFilters() && (
        <div className="px-4 pb-2">
          <motion.div
            ...
            className="bg-[#FF6A00]/5 border border-[#FF6A00]/20 rounded-xl p-3 flex items-center justify-between"
          >
            <div className="flex items-center gap-2">
              <Filter className="w-4 h-4 text-[#FF6A00]" />
              <span className="text-sm text-gray-700 dark:text-gray-300">
                <span className="font-bold text-[#FF6A00]">{Object.values(filters).flat().length}</span> filter{Object.values(filters).flat().length !== 1 ? 's' : ''} applied
              </span>
            </div>
            <button onClick={handleClearFilters} className="text-xs text-[#FF6A00] font-semibold">
              Clear all
            </button>
          </motion.div>
        </div>
      ...
      <div className="px-4 pb-24 space-y-3">
        {loading && (
          <div className="flex flex-col items-center justify-center py-16 gap-3 bg-white dark:bg-[#111] rounded-2xl border border-gray-100 dark:border-gray-800">
            <div className="w-7 h-7 border-2 border-[#FF6A00]/30 border-t-[#FF6A00] rounded-full animate-spin"></div>
              ...
              <div className="px-4 py-3 pb-8 space-y-2">
                {dateRangeOptions.map((option) => {
                  ...
                  return (
                    ...
                    >
                      <div>
                        <p className={`text-sm font-semibold capitalize ${isSelected ? "text-[#FF6A00]" : "text-gray-900 dark:text-white"}`}>{option.label}</p>
                        {!option.custom && (
                      ...
                      {isSelected && <span className="text-xs font-bold text-[#FF6A00]">Selected</span>}
                    </button>
                  )
                })}
              </div>
