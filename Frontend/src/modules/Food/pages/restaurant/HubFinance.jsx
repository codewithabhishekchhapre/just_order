          ...
          <div className="space-y-5">
                  ...
                  <button
                    ...
                    className={`w-full py-3.5 rounded-xl font-bold text-sm flex items-center justify-center gap-2 transition-all ${
                      financeData?.earnings?.availableBalance > 0
                        ? "bg-white text-[#FF6A00] active:scale-[0.98]"
            ...
            <div className="bg-white dark:bg-[#111] rounded-2xl border border-gray-100 dark:border-gray-800 p-4">
              <div className="flex items-center justify-between mb-3">
                ...
                <button onClick={() => navigate("/restaurant/refer-earn")} className="text-xs font-semibold text-[#FF6A00]">Refer more</button>
              </div>
              <div className="flex items-center justify-between">
                ...
                <div className="w-12 h-12 bg-[#FF6A00]/10 rounded-2xl flex items-center justify-center">
            ...
            <div className="bg-white dark:bg-[#111] rounded-2xl border border-gray-100 dark:border-gray-800 overflow-hidden">
              <div className="px-4 py-3 border-b border-gray-50 dark:border-gray-800/60 flex items-center justify-between">
                ...
                <button onClick={() => navigate("/restaurant/withdrawal-history")} className="text-xs font-semibold text-[#FF6A00]">View all</button>
              </div>
              <div className="p-4">
                {loadingWithdrawals ? (
