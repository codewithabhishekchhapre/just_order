        ...
        <div className="px-4 py-6 space-y-6">
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            <button
              ...
              className="text-[#FF6A00] text-sm font-medium hover:text-[#e05e00] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              Edit photo
            </button>
            <input
            ...
            <div>
              ...
              <div className="relative">
                <Input
                  ...
                  disabled={loading || saving}
                />
                <Edit className="absolute right-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[#FF6A00]" />
              </div>
            </div>
