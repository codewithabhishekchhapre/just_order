            ...
            <div className="mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    <h1 className="text-2xl font-bold text-slate-900 flex items-center gap-2">
                        <Settings2 className="w-7 h-7 text-[#FF6A00]" />
                ...
                {canCreatePlan && (
                    <button
                        ...
                        className="bg-[#FF6A00] hover:bg-[#E64D02] text-white px-4 py-2 rounded-lg font-semibold flex items-center justify-center gap-2 transition-colors shadow-sm"
                    >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                ...
                <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm">
                    ...
                    <h3 className="text-2xl font-bold text-slate-900 mt-2">
                        {overviewLoading ? <Loader2 className="w-5 h-5 animate-spin inline text-[#FF6A00]" /> : overviewData?.activeSubscribers?.total || 0}
                    </h3>
                </div>
                <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm">
                ...
                <div className="p-4 border-b border-slate-100 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div className="relative w-full sm:w-80">
                        ...
                        <input
                            ...
                            className="w-full pl-10 pr-4 py-2 bg-slate-50 border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#FF6A00]/20 focus:border-[#FF6A00] transition-all"
                        />
                    </div>
                    ...
                    <div className="flex items-center gap-2">
                        <button
                            ...
                            className={`flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium transition-all ${showInactive
                                    ? 'bg-red-50 text-[#FF6A00] border border-red-200'
                ...
                >
                    <div className="flex justify-between items-start">
                        <div>
                            ...
                            <h3 className="text-2xl font-bold text-slate-900 mt-2">
                                {overviewLoading ? <Loader2 className="w-5 h-5 animate-spin text-[#FF6A00]" /> : `₹${overviewData?.totalRevenue || 0}`}
                            </h3>
                            <p className="text-[10px] text-slate-400 mt-1">All time collected</p>
                        </div>
                        <div className="p-2.5 rounded-lg bg-red-50 text-[#FF6A00] transition-colors group-hover:bg-[#FF6A00] group-hover:text-white">
                ...
                >
                    <div className="flex justify-between items-start">
                        <div>
                            ...
                            <h3 className="text-2xl font-bold text-slate-900 mt-2">
                                {overviewLoading ? <Loader2 className="w-5 h-5 animate-spin text-[#FF6A00]" /> : overviewData?.activeSubscribers?.total || 0}
                            </h3>
                ...
                >
                    <div className="flex justify-between items-start">
                        <div>
                            ...
                            <h3 className="text-2xl font-bold text-slate-900 mt-2">
                                {overviewLoading ? <Loader2 className="w-5 h-5 animate-spin text-[#FF6A00]" /> : overviewData?.oneDayPassCount || 0}
                            </h3>
                ...
                >
                    <div className="flex justify-between items-start">
                        <div>
                            ...
                            <h3 className="text-2xl font-bold text-slate-900 mt-2">
                                {overviewLoading ? <Loader2 className="w-5 h-5 animate-spin text-[#FF6A00]" /> : `₹${overviewData?.walletRechargeRevenue || 0}`}
                            </h3>
                ...
                >
                    <div className="flex justify-between items-start">
                        <div>
                            ...
                            <h3 className="text-2xl font-bold text-slate-900 mt-2">
                                {overviewLoading ? <Loader2 className="w-5 h-5 animate-spin text-[#FF6A00]" /> : `₹${overviewData?.recurringPlanRevenue || 0}`}
                            </h3>
                ...
                >
                    <div className="flex justify-between items-start">
                        <div>
                            ...
                            <h3 className="text-2xl font-bold text-slate-900 mt-2">
                                {overviewLoading ? <Loader2 className="w-5 h-5 animate-spin text-[#FF6A00]" /> : overviewData?.expiringSoon || 0}
                            </h3>
                        ...
                        {analyticsLoading ? (
                            ...
                            <ResponsiveContainer width="100%" height="100%">
                                <AreaChart data={analyticsData.revenueTrend} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                                    ...
                                    <Area type="monotone" dataKey="revenue" name="Total Revenue" stroke="#FF6A00" strokeWidth={2} fillOpacity={1} fill="url(#colorRev)" />
                                </AreaChart>
                            </ResponsiveContainer>
                        )}
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <button
                                ...
                                className="flex items-center gap-1.5 px-3 py-1.5 bg-[#FF6A00] hover:bg-[#E64D02] text-white rounded-lg text-xs font-bold transition-all shadow-sm shadow-red-100"
                            >
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-3">
                        ...
                        <div className="relative col-span-1 sm:col-span-2">
                            ...
                            <input
                                ...
                                className="w-full pl-9 pr-4 py-2 border border-slate-200 rounded-lg text-xs focus:outline-none focus:ring-2 focus:ring-[#FF6A00]/20 focus:border-[#FF6A00] bg-white transition-all"
                            />
                        </div>
                        ...
                        <div>
                            <select
                                ...
                                className="w-full px-3 py-2 border border-slate-200 rounded-lg text-xs focus:outline-none focus:ring-2 focus:ring-[#FF6A00]/20 bg-white cursor-pointer"
                            >
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 pt-2 border-t border-slate-100">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <input
                                ...
                                className="px-3 py-1.5 border border-slate-200 rounded-lg text-xs focus:outline-none focus:ring-2 focus:ring-[#FF6A00]/20 bg-white cursor-pointer"
                            />
                        </div>
                                        ...
                                        <tr key={item._id} className="hover:bg-slate-50/50 transition-colors">
                                            ...
                                            <td className="px-5 py-3.5">
                                                <div className="flex flex-col">
                                                    ...
                                                    <span className={`inline-block w-fit px-1.5 py-0.5 rounded text-[8px] font-black uppercase tracking-wider mt-1 ${item.userType === 'RESTAURANT' ? 'bg-red-50 text-[#FF6A00]' : 'bg-blue-50 text-blue-600'
                                                        }`}>
                    ...
                    <form onSubmit={handleSubmit} className="p-6 space-y-5 bg-white">
                        <div className="space-y-1.5">
                            ...
                            <input
                                ...
                                className="w-full px-4 py-2.5 bg-white border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-4 focus:ring-[#FF6A00]/10 focus:border-[#FF6A00] transition-all placeholder:text-slate-400"
                            />
                        </div>
                        ...
                        <div className="space-y-1.5">
                            ...
                            <textarea
                                ...
                                rows="3"
                                className="w-full px-4 py-2.5 bg-white border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-4 focus:ring-[#FF6A00]/10 focus:border-[#FF6A00] transition-all placeholder:text-slate-400 resize-none"
                            />
                        </div>
                            ...
                            <div className="space-y-1.5">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        placeholder="0.00"
                                        className="w-full pl-8 pr-4 py-2.5 bg-white border border-slate-200 rounded-xl text-sm font-bold focus:outline-none focus:ring-4 focus:ring-[#FF6A00]/10 focus:border-[#FF6A00] transition-all"
                                    />
                                </div>
                            </div>
                            <div className="space-y-1.5">
                                ...
                                <div className="relative">
                                    <select
                                        ...
                                        className="w-full px-4 py-2.5 bg-white border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-4 focus:ring-[#FF6A00]/10 focus:border-[#FF6A00] transition-all appearance-none cursor-pointer"
                                    >
                        ...
                        <div className="grid grid-cols-2 gap-5">
                            <div className="space-y-1.5">
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-2.5 bg-white border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-4 focus:ring-[#FF6A00]/10 focus:border-[#FF6A00] transition-all"
                                />
                            </div>
                            <div className="space-y-1.5">
                                ...
                                <div className={`h-[42px] px-4 rounded-xl text-[10px] font-black tracking-wider flex items-center justify-center border transition-colors ${formData.durationUnit === 'DAY'
                                        ...
                                        : 'bg-red-50 text-[#FF6A00] border-red-100'
                                    }`}>
                        ...
                        <DialogFooter className="pt-4 flex items-center gap-3 sm:justify-end border-t border-slate-100 -mx-6 px-6 -mb-6 pb-6 mt-6 bg-slate-50/50">
                            ...
                            <button
                                ...
                                className="bg-[#FF6A00] hover:bg-[#E64D02] text-white px-8 py-2.5 rounded-xl font-bold flex items-center gap-2 disabled:opacity-70 transition-all shadow-lg shadow-red-200"
                            >
                                {isSubmitting ? (
                                    <>
