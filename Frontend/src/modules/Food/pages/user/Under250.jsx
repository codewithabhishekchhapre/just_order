        ...
        <section className="space-y-1 sm:space-y-1.5">
          ...
          >
            ...
            <div className="flex-shrink-0 cursor-pointer" onClick={() => setActiveCategory(null)}>
              ...
              >
                <div className={`w-14 h-14 sm:w-20 sm:h-20 md:w-24 md:h-24 rounded-full overflow-hidden shadow-md transition-all ${!activeCategory ? 'ring-2 ring-[#FF6A00] ring-offset-2' : ''}`}>
                  <OptimizedImage
                    src={offerImage}
                    alt="All"
                ...
                <span className={`text-xs sm:text-sm md:text-base font-semibold text-gray-800 dark:text-gray-200 text-center pb-1 ${!activeCategory ? 'text-[#FF6A00]' : ''}`}>
                  All
                </span>
              </motion.div>
            </div>
              ...
              return (
                <div key={category.id} className="flex-shrink-0 cursor-pointer" onClick={() => setActiveCategory(isActive ? null : category.id)}>
                    <motion.div
                      ...
                      transition={{ type: "spring", stiffness: 300, damping: 20 }}
                    >
                      <div className={`w-14 h-14 sm:w-20 sm:h-20 md:w-24 md:h-24 rounded-full overflow-hidden shadow-md transition-all ${isActive ? 'ring-2 ring-[#FF6A00] ring-offset-2' : ''}`}>
                        <OptimizedImage
                          src={category.image}
                          alt={category.name}
                          className="w-full h-full bg-white rounded-full"
                      ...
                      <span className={`text-xs sm:text-sm md:text-base font-semibold text-gray-800 dark:text-gray-200 text-center pb-1 ${isActive ? 'text-[#FF6A00]' : ''}`}>
                                ...
                                {quantity > 0 ? (
                                  <Link to="/user/cart" onClick={(e) => e.stopPropagation()}>
                                    <Button
                                      variant={"outline"}
                                      size="sm"
                                      className="bg-[#FFF5F5] text-[#FF6A00] border-[#FF6A00] hover:bg-[#FF6A00] hover:text-white h-7 md:h-8 lg:h-9 px-3 md:px-4 lg:px-5 text-xs md:text-sm lg:text-base"
                                    >
                                      View cart
                                    </Button>
                                  </Link>
                                  ...
                                  <Button
                                    ...
                                    className={`h-7 md:h-8 lg:h-9 px-3 md:px-4 lg:px-5 text-xs md:text-sm lg:text-base ${shouldShowGrayscale
                                      ...
                                      : 'bg-[#FFF5F5] text-[#FF6A00] border-[#FF6A00] hover:bg-[#FF6A00] hover:text-white'
                                      }`}
                                    onClick={(e) => {
                                      e.stopPropagation()
            ...
            >
              ...
              <div className="flex items-center justify-between px-4 md:px-6 py-4 md:py-5 border-b dark:border-gray-800">
                ...
                <button
                  ...
                  className="text-[#FF6A00] dark:text-[#F97316] font-medium text-sm md:text-base"
                >
                  Clear all
                </button>
              </div>
                  ...
                  {sortOptions.map((option) => (
                    <button
                      ...
                      className={`px-4 md:px-5 lg:px-6 py-3 md:py-4 rounded-xl border text-left transition-colors ${draftSelectedSort === option.id
                        ? 'border-[#FF6A00] bg-red-50 dark:bg-red-900/20'
                        : 'border-gray-200 dark:border-gray-800 hover:border-[#FF6A00]'
                        }`}
                    >
                      <span className={`text-sm md:text-base lg:text-lg font-medium ${draftSelectedSort === option.id ? 'text-[#FF6A00] dark:text-[#F97316]' : 'text-gray-700 dark:text-gray-300'}`}>
                        {option.label}
                      </span>
                    </button>
                  ))}
              ...
              <div className="flex items-center gap-4 md:gap-6 px-4 md:px-6 py-4 md:py-5 border-t dark:border-gray-800 bg-white dark:bg-[#1a1a1a]">
                ...
                <button
                  onClick={handleApply}
                  className="flex-1 py-3 md:py-4 font-semibold rounded-xl transition-colors text-sm md:text-base bg-[#FF6A00] text-white hover:bg-[#C83C00]"
                >
                  Apply
                </button>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                {[
                  ...
                  <button
                    ...
                    className="rounded-2xl border border-gray-200 dark:border-gray-700 px-4 py-3 text-sm font-medium text-gray-800 dark:text-gray-200 hover:border-[#FF6A00] hover:text-[#FF6A00] transition-colors"
                  >
                    {option.label}
                  </button>
                ))}
