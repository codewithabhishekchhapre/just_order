    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-[#0a0a0a] pb-10">
        ...
        <div className="px-4 py-8 text-center">
          ...
          <Link to="/user">
            <button className="mt-4 text-[#FF6A00] font-medium">Start Ordering</button>
          </Link>
        </div>
      </div>
    )
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {order.restaurantId && (
                        <Link to={`/user/restaurants/${order.restaurantId}`}>
                          <button className="text-xs text-[#FF6A00] font-medium flex items-center mt-1 hover:text-[#C83C00]">
                ...
                <div className="px-4 py-2 flex items-center justify-between">
                  ...
                  <div className="flex items-center ml-4">
                    <Link to={`/user/orders/${order.id}`}>
                      <button className="text-xs text-[#FF6A00] font-medium hover:text-[#C83C00] flex items-center gap-1">
                        View Details
                ...
                <div className="px-4 py-3 flex items-center justify-between">
                  ...
                  {isRestaurantCancelled ? (
                    ...
                    <div>
                      ...
                      <button
                        ...
                        className="text-xs text-[#FF6A00] font-medium mt-0.5 flex items-center"
                      >
                    ...
                    <div>
                      ...
                      {countdowns[order.id] && countdowns[order.id] > 0 && (
                        <div className="flex items-center gap-1 mt-1 text-xs text-[#FF6A00] font-medium">
                          <Clock size={12} />
                  ...
                  {isDelivered && !paymentFailed && (
                    <button
                      ...
                      className="bg-[#FF6A00] hover:bg-[#C83C00] text-white px-4 py-2 rounded-lg text-sm font-medium flex items-center gap-1 shadow-sm transition-colors"
                    >
      ...
      {ratingModal.open && ratingModal.order && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm px-4 animate-in fade-in duration-200">
          <div className="w-full max-w-md rounded-3xl bg-white shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300">
            ...
            <div className="bg-gradient-to-r from-[#FF6A00] to-[#C83C00] px-6 py-5">
            ...
            <div className="px-6 py-6">
              <div className="mb-6">
                ...
                <textarea
                  ...
                  className="w-full rounded-xl border-2 border-gray-200 px-4 py-2 text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#FF6A00] focus:border-[#FF6A00] resize-none transition-all"
              ...
              <button
                ...
                className="w-full rounded-xl bg-gradient-to-r from-[#FF6A00] to-[#C83C00] text-white text-base font-bold py-3.5 hover:from-[#C83C00] hover:to-[#C83C00] disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-lg ring-red-500/30 flex items-center justify-center gap-2"
              >
                {submittingRating ? (
                  <>
            ...
            <div className="px-5 py-5 space-y-3">
              {typeof navigator !== "undefined" && navigator.share && (
                <button
                  ...
                  className="w-full rounded-2xl bg-[#FF6A00] px-4 py-3 text-sm font-semibold text-white flex items-center justify-center gap-2 hover:bg-[#C83C00] transition-colors"
                >
