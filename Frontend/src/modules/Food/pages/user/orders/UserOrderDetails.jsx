      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center space-y-3">
          ...
          <button
            ...
            className="px-4 py-2 rounded-lg bg-[#FF6A00] text-white text-sm font-semibold"
          >
            Back to Orders
          </button>
        </div>
    ...
    <div className="min-h-screen bg-gray-50 pb-24 font-sans relative">
                  ...
                  <div className="flex items-start justify-between gap-3">
                    ...
                    {source.phone ? (
                      <button
                        ...
                        className="w-8 h-8 rounded-full border border-gray-200 flex items-center justify-center text-[#FF6A00] hover:bg-red-50 shrink-0"
                      >
        ...
        <div className="bg-white rounded-xl shadow-sm overflow-hidden">
          <div className="p-4 flex justify-between items-center border-b border-gray-100">
            ...
            <button
              ...
              className="w-7 h-7 rounded-full bg-red-50 flex items-center justify-center text-[#FF6A00] hover:bg-red-100"
            >
          ...
          <div className="p-4 space-y-2 text-sm">
            ...
            <div className="flex justify-between">
              ...
              {pricing.deliveryFee === 0 && (
                <span className="text-[#FF6A00] text-[10px] font-bold border border-[#FF6A00] px-1 rounded ml-1">
                  FREE
                </span>
              )}
              <span className="text-[#FF6A00] font-medium uppercase">
          ...
          {savings > 0 && (
            <div className="relative bg-red-50 p-3 pb-4 mt-2">
              ...
              <div className="flex items-center justify-center gap-2 pt-1 text-[#FF6A00] font-bold text-sm">
                <span>??</span>
                <span>
      ...
      <div className="fixed bottom-0 w-full bg-white border-t border-gray-200 p-4 flex gap-3 z-20">
        <button
          ...
          className="flex-1 bg-[#FF6A00] text-white py-3 rounded-lg font-semibold flex items-center justify-center gap-2 hover:bg-[#C83C00] transition-colors"
        >
        ...
        <button
          type="button"
          onClick={handleDownloadSummary}
          className="flex-1 bg-white border border-[#FF6A00] text-[#FF6A00] py-3 rounded-lg font-semibold flex items-center justify-center gap-2 hover:bg-red-50 transition-colors"
        >
          <Download className="w-4 h-4" />
          Invoice
        </button>
