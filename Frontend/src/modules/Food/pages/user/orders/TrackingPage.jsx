...
const TrackingPage = () => {
  ...
  return (
    <div className="relative min-h-screen bg-gray-900 font-sans overflow-hidden">
      ...
      <div className="absolute top-0 left-0 right-0 z-20 bg-[#FF6A00] p-4 pt-4 rounded-b-2xl shadow-lg">
      ...
      <div className="absolute top-0 left-0 w-full h-full z-0">
        ...
        <div className="absolute bottom-[50vh] left-4 right-4 z-10 bg-white rounded-xl p-4 shadow-lg border border-gray-200">
          ...
          <div className="w-full h-2 bg-gray-200 rounded-full overflow-hidden">
            <div className="h-full bg-[#FF6A00] rounded-full" style={{ width: '60%' }}></div>
          </div>
        </div>
      </div>
