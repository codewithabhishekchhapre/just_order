                    ...
                    >
                      <div className="group">
                        ...
                        <div className="relative h-32 sm:h-36 rounded-xl overflow-hidden mb-2">
                          ...
                          />
                          {/* Offer Badge */}
                          <div className="absolute top-2 left-2 bg-[#FF6A00] text-white text-[10px] sm:text-xs font-semibold px-2 py-1 rounded">
                            {dish.offer}
                          </div>
                        </div>
                    ...
                    <Card key={o.id || o.offerId} className="border border-slate-200 shadow-sm">
                      <CardContent className="p-4 space-y-2">
                        <div className="flex items-start justify-between gap-3">
                          ...
                          <span className="px-2 py-1 rounded-md text-xs font-semibold bg-[#FF6A00] text-white">
                            {o.title || "Offer"}
                          </span>
                        </div>
