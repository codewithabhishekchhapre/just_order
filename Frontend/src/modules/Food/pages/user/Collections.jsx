...
const gradientColors = [
  ...
  "bg-gradient-to-br from-[#FF6A00] to-[#C83C00]",
  "bg-gradient-to-br from-purple-500 to-pink-600",
  "bg-gradient-to-br from-red-500 to-rose-600",
  "bg-gradient-to-br from-rose-400 to-red-500",
  "bg-gradient-to-br from-pink-500 to-red-600",
  "bg-gradient-to-br from-pink-400 to-rose-600",
  "bg-gradient-to-br from-red-400 to-[#FF6A00]",
]
      ...
      <div className="sticky top-0 bg-white dark:bg-[#1a1a1a] z-10 border-b dark:border-gray-800">
        <div className="flex">
          ...
          >
            Delivery
            {activeTab === "delivery" && (
              <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-20 h-1 bg-[#FF6A00] rounded-full" />
            )}
          </button>
          <button
      ...
      <div className="px-4 sm:px-6 md:px-8 lg:px-10 py-6 md:py-8 lg:py-10">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-5 lg:gap-6">
            ...
            >
              <div className="w-12 h-12 rounded-full bg-red-50 dark:bg-[#FF6A00]/20 flex items-center justify-center border-2 border-[#FF6A00]/30 dark:border-[#FF6A00]/40">
                <Plus className="h-6 w-6 text-[#FF6A00] dark:text-[#FF6A00]" />
              </div>
          ...
          <div className="relative bg-white dark:bg-[#1a1a1a] rounded-2xl shadow-2xl w-[90%] max-w-sm mx-4 overflow-hidden animate-[slideUp_0.3s_ease-out]">
            ...
            <div className="p-4 space-y-4">
              ...
              <Input
                ...
                className="w-full h-12 text-base border-2 border-gray-200 dark:border-gray-700 focus:border-[#FF6A00] dark:focus:border-[#FF6A00] rounded-xl bg-white dark:bg-[#2a2a2a] text-gray-900 dark:text-white placeholder:text-gray-500 dark:placeholder:text-gray-400"
                autoFocus
              />
            ...
            <div className="flex gap-3 p-4 bg-gray-50 dark:bg-gray-800">
              ...
              <Button
                ...
                className="flex-1 h-11 bg-[#FF6A00] hover:bg-[#C83C00] text-white rounded-xl font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Create Collection
              </Button>
            </div>
