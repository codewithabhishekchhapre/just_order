...
export default function TableBookingSuccess() {
    ...
    return (
        <AnimatedPage className="bg-white min-h-screen flex flex-col items-center justify-center p-6 pb-24">
            ...
            >
                <CheckCircle2 className="w-12 h-12 text-[#FF6A00]" />
            </motion.div>
            ...
            >
                ...
                <div className="pt-2">
                    <span className="bg-red-50 text-[#FF6A00] px-4 py-1 rounded-full text-xs font-bold uppercase tracking-widest border border-[#FF6A00]/20">
