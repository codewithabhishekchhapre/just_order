    ...
    <div className="min-h-screen bg-gray-50 pb-24">
      ...
      <div className="bg-white p-4 flex items-center sticky top-0 z-20 shadow-sm">
        ...
        <button
          ...
          className="ml-auto text-sm font-semibold text-[#FF6A00]"
        >
          View History
        </button>
      </div>
      ...
      <form onSubmit={handleSubmit} className="mx-4 mt-4 space-y-4">
        ...
        <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 p-4 z-20">
          <button
            type="submit"
            disabled={submitting}
            className="w-full bg-[#FF6A00] text-white py-3 rounded-lg font-semibold flex items-center justify-center gap-2 hover:bg-[#C83C00] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {submitting ? (
              <>
