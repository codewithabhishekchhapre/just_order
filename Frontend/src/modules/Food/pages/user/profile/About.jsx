            ...
            <div className="bg-gradient-to-br from-red-50 to-amber-50 dark:from-red-900/20 dark:to-amber-900/20 p-8 md:p-10 text-center">
              ...
              >
                <div className="relative">
                  <div className="absolute inset-0 bg-[#FF6A00] rounded-full blur-2xl opacity-30 animate-pulse" />
            ...
            <CardContent className="p-5 md:p-6">
              ...
              <div className="space-y-3">
                ...
                >
                  ...
                  <div className="flex-1">
                    <div className="text-base font-medium text-gray-900 dark:text-white group-hover:text-[#FF6A00] dark:group-hover:text-[#F97316] transition-colors">
