      ...
      <header className="sticky top-0 z-50 bg-[#ffffffcc] border-b border-[#EDE8E0] shadow-xs">
        <div className="flex items-center justify-between px-6 py-3">
          ...
          <div className="flex items-center gap-3">
            <button
              onClick={onMenuClick}
              className="lg:hidden p-2 rounded-md text-[#5C5247] hover:bg-[#FFF3EB] hover:text-[#FF6A00] transition-colors"
          ...
          <div className="flex-1 flex justify-center max-w-md mx-8">
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 rounded-full bg-white text-[#9E8F7E] cursor-pointer hover:bg-[#FFF3EB]/85 hover:text-[#FF6A00] hover:border-[#FF6A00]/50 transition-colors w-full border border-[#EDE8E0]"
            >
