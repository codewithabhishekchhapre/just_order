        ...
        {itemCount > 0 && !shouldHidePill && (
          ...
          >
            <button
              ...
              className={`bg-[#FF6A00] text-white rounded-full shadow-xl shadow-orange-900/30 px-3 py-2 flex items-center gap-2 hover:bg-[#E85D04] transition-all duration-300 pointer-events-auto border border-red-800/30 backdrop-blur-sm cursor-pointer ${pillClassName}`}
            >
