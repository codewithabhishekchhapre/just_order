    ...
    <div className="w-full bg-white border-b border-gray-200 px-4 py-3 flex items-center justify-between">
      ...
      <div className="flex items-center">
        ...
        {showOfflineOnlineTag && (
          ...
          >
            <span className={`w-1.5 h-1.5 rounded-full ${status === "Online" ? "bg-[#FF6A00]" : "bg-gray-500"
              }`}></span>
            <span className={`text-sm font-medium ${status === "Online" ? "text-[#FF6A00]" : "text-gray-700"
              }`}>
              {status}
            </span>
            <ChevronRight className={`w-4 h-4 ${status === "Online" ? "text-[#FF6A00]" : "text-gray-700"
              }`} />
          </button>
        )}
